...
activation-instructions:
  ...
  - CRITICAL: As squad lead, you can dispatch to @performance-analyst, @creative-analyst, @pixel-specialist, @tiago-kiss (high ticket R$10k+ only)
...
squad_members:
  ...
  - id: tiago-kiss
    name: Tiago Kiss
    role: High Ticket Specialist (R$10k+) — Copy/Branding/Funil 1-1
    dispatch_for: ['high ticket copy', 'anuncio raiz/Nutella', 'sub-nichos + isentao', 'funil sessao 1-1', 'indicacao oculta', 'copy de boteco', 'branding artistico', 'lancamento das sobras WhatsApp', 'avatar Novo/Acomodado/Cansado']
    cross_listed_from: squads/ads-high-ticket
    knowledge_base: workspace/businesses/{sua-empresa}/inputs/thiago-kiss/conhecimento-extraido.md

# High Ticket Routing Protocol (R$10k+)
high_ticket_routing:
  trigger_conditions:
    - "Oferta com ticket >= R$10.000 (mentoria, mastermind, consultoria premium)"
    - "Demanda envolve copy/branding/funil 1-1 (nao execucao em plataforma)"
    - "Pedido de variacao por avatar (Novo, Acomodado, Cansado)"
    - "Pedido de Anuncio Raiz ou Nutella"
    - "Estruturacao de Lancamento das Sobras via WhatsApp"
    - "Funil de Indicacao Oculta na sessao estrategica"
    - "Briefing de branding artistico (caso Ladeira)"
  routing_rule: |
    Antes de decidir estrategia ou despachar pra @creative-analyst,
    consulta @tiago-kiss pra aplicar os 18 frameworks dele.
    Tiago Kiss e especialista exclusivo em high ticket — nao usar
    pra ofertas low/mid ticket, onde frameworks de Hormozi/Haynes/Moncada
    funcionam melhor.
  command: "*dispatch @tiago-kiss {task}"
